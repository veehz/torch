...
function Ie(...r) {
  const e = W(r), t = new h(Array(e.reduce((s, n) => s * n, 1)).fill(Math.random()));
  return t.shape = e, t;
}
function H(...r) {
  const e = W(r), t = new h(Array(e.reduce((s, n) => s * n, 1)).fill(Math.random()));
...
function ee(...r) {
  const e = W(r), t = new h(Array(e.reduce((s, n) => s * n, 1)).fill(1));
  return t.shape = e, t;
}
function ce(...r) {
  const e = W(r), t = new h(Array(e.reduce((s, n) => s * n, 1)).fill(0));
  return t.shape = e, t;
}
function ze(r) {
  return ee(r.shape);
