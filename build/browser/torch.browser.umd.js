(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.torch = {}));
...
var __name = (target, value2) => __defProp(target, "name", { value: value2, configurable: true });
   ...
   */
  var gpuBrowser$1 = gpuBrowser$2.exports;
  var hasRequiredGpuBrowser;
  function requireGpuBrowser() {
    if (hasRequiredGpuBrowser) return gpuBrowser$2.exports;
    hasRequiredGpuBrowser = 1;
    (function(module2, exports3) {
      (function(f) {
        ...
        return (/* @__PURE__ */ (function() {
          ...
          __name(r, "r");
          return r;
        })())({ 1: [function(require2, module4, exports5) {
          (function(global2, factory) {
            typeof exports5 === "object" && typeof module4 !== "undefined" ? factory(exports5) : typeof define2 === "function" && define2.amd ? define2(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.acorn = {}));
          })(this, (function(exports6) {
            "use strict";
            ...
            Parser.parseExpressionAt = /* @__PURE__ */ __name(function parseExpressionAt2(input, pos, options) {
              var parser = new this(options, input, pos);
              parser.nextToken();
              return parser.parseExpression();
            }, "parseExpressionAt");
            Parser.tokenizer = /* @__PURE__ */ __name(function tokenizer2(input, options) {
            ...
            pp$8.parseTopLevel = function(node) {
              var exports7 = /* @__PURE__ */ Object.create(null);
              if (!node.body) {
                node.body = [];
              }
              while (this.type !== types$1.eof) {
                var stmt = this.parseStatement(null, true, exports7);
                node.body.push(stmt);
              }
              if (this.inModule) {
            ...
            pp$8.parseStatement = function(context, topLevel, exports7) {
              ...
              switch (starttype) {
                ...
                case types$1._import:
                  ...
                  return starttype === types$1._import ? this.parseImport(node) : this.parseExport(node, exports7);
                default:
            ...
            pp$8.parseExportAllDeclaration = function(node, exports7) {
              if (this.options.ecmaVersion >= 11) {
                if (this.eatContextual("as")) {
                  node.exported = this.parseModuleExportName();
                  this.checkExport(exports7, node.exported, this.lastTokStart);
                } else {
                  node.exported = null;
                }
              }
            ...
            pp$8.parseExport = function(node, exports7) {
              this.next();
              if (this.eat(types$1.star)) {
                return this.parseExportAllDeclaration(node, exports7);
              }
              if (this.eat(types$1._default)) {
                this.checkExport(exports7, "default", this.lastTokStart);
              ...
              if (this.shouldParseExportStatement()) {
                ...
                if (node.declaration.type === "VariableDeclaration") {
                  this.checkVariableExport(exports7, node.declaration.declarations);
                } else {
                  this.checkExport(exports7, node.declaration.id, node.declaration.id.start);
                }
                node.specifiers = [];
                node.source = null;
              } else {
                node.declaration = null;
                node.specifiers = this.parseExportSpecifiers(exports7);
            ...
            pp$8.checkExport = function(exports7, name2, pos) {
              if (!exports7) {
                return;
              }
              ...
              if (hasOwn(exports7, name2)) {
                this.raiseRecoverable(pos, "Duplicate export '" + name2 + "'");
              }
              exports7[name2] = true;
            };
            pp$8.checkPatternExport = function(exports7, pat) {
              var type = pat.type;
              if (type === "Identifier") {
                this.checkExport(exports7, pat, pat.start);
              } else if (type === "ObjectPattern") {
                for (var i2 = 0, list2 = pat.properties; i2 < list2.length; i2 += 1) {
                  var prop = list2[i2];
                  this.checkPatternExport(exports7, prop);
                }
              } else if (type === "ArrayPattern") {
                for (var i$1 = 0, list$1 = pat.elements; i$1 < list$1.length; i$1 += 1) {
                  var elt = list$1[i$1];
                  if (elt) {
                    this.checkPatternExport(exports7, elt);
                  }
                }
              } else if (type === "Property") {
                this.checkPatternExport(exports7, pat.value);
              } else if (type === "AssignmentPattern") {
                this.checkPatternExport(exports7, pat.left);
              } else if (type === "RestElement") {
                this.checkPatternExport(exports7, pat.argument);
              }
            };
            pp$8.checkVariableExport = function(exports7, decls) {
              if (!exports7) {
                return;
              }
              for (var i2 = 0, list2 = decls; i2 < list2.length; i2 += 1) {
                var decl = list2[i2];
                this.checkPatternExport(exports7, decl.id);
              }
            };
            pp$8.shouldParseExportStatement = function() {
              return this.type.keyword === "var" || this.type.keyword === "const" || this.type.keyword === "class" || this.type.keyword === "function" || this.isLet() || this.isAsyncFunction();
            };
            pp$8.parseExportSpecifier = function(exports7) {
              var node = this.startNode();
            ...
            pp$8.parseExportSpecifiers = function(exports7) {
              ...
              while (!this.eat(types$1.braceR)) {
                ...
                nodes.push(this.parseExportSpecifier(exports7));
              }
              return nodes;
            };
            ...
            exports6.Node = Node;
            exports6.Parser = Parser;
            exports6.Position = Position;
            exports6.SourceLocation = SourceLocation;
            exports6.TokContext = TokContext;
            exports6.Token = Token;
            exports6.TokenType = TokenType;
            exports6.defaultOptions = defaultOptions;
            exports6.getLineInfo = getLineInfo;
            exports6.isIdentifierChar = isIdentifierChar;
            exports6.isIdentifierStart = isIdentifierStart;
            exports6.isNewLine = isNewLine;
            exports6.keywordTypes = keywords;
            exports6.lineBreak = lineBreak;
            exports6.lineBreakG = lineBreakG;
            exports6.nonASCIIwhitespace = nonASCIIwhitespace;
            exports6.parse = parse;
            exports6.parseExpressionAt = parseExpressionAt;
            exports6.tokContexts = types;
            exports6.tokTypes = types$1;
            exports6.tokenizer = tokenizer;
            exports6.version = version;
          }));
        }, {}], 2: [function(require2, module4, exports5) {
        }, {}], 3: [function(require2, module4, exports5) {
          function glWiretap(gl, options = {}) {
            ...
            __name(addVariable, "addVariable");
...
${indent}})();`);
            ...
            __name(checkThrowError, "checkThrowError");
            function methodCallToString(method, args) {
              return `${contextName}.${method}(${argumentsToString(args, { contextName, contextVariables, getEntity, addVariable, variables, onUnrecognizedArgumentLookup })})`;
            }
            __name(methodCallToString, "methodCallToString");
            ...
            __name(getContextVariableName, "getContextVariableName");
          }
          __name(glWiretap, "glWiretap");
          function glExtensionWiretap(extension, options) {
            ...
            __name(getExtensionEntity, "getExtensionEntity");
            function methodCallToString(method, args) {
          ...
          __name(glExtensionWiretap, "glExtensionWiretap");
          ...
          __name(argumentsToString, "argumentsToString");
          ...
          __name(argumentToString, "argumentToString");
          function trackablePrimitive(value2) {
            return new value2.constructor(value2);
          }
          __name(trackablePrimitive, "trackablePrimitive");
          if (typeof module4 !== "undefined") {
            module4.exports = { glWiretap, glExtensionWiretap };
          }
          if (typeof window !== "undefined") {
            glWiretap.glExtensionWiretap = glExtensionWiretap;
            window.glWiretap = glWiretap;
          }
        }, {}], 4: [function(require2, module4, exports5) {
          ...
          __name(setupArguments, "setupArguments");
          function mock1D() {
          ...
          __name(mock2DGraphical, "mock2DGraphical");
          function mock3D() {
            const args = setupArguments(arguments);
          ...
          function apiDecorate(kernel) {
            ...
            const mockMethod = /* @__PURE__ */ __name(() => kernel, "mockMethod");
            const methods = [
              "setWarnVarUsage",
              "setArgumentTypes",
              "setTactic",
          ...
          __name(apiDecorate, "apiDecorate");
          ...
          __name(setupGraphical, "setupGraphical");
          ...
          __name(setupOutput, "setupOutput");
          ...
          __name(flipPixels, "flipPixels");
          module4.exports = {
            gpuMock
          };
        }, {}], 5: [function(require2, module4, exports5) {
  ...
  ${utils.getFunctionBodyFromString(fnString)}
        ...
        }, { "./utils": 114 }], 6: [function(require2, module4, exports5) {
          const { FunctionNode } = require2("../function-node");
          const _CPUFunctionNode = class _CPUFunctionNode extends FunctionNode {
...
${updateArr.join("")};`);
          ...
          __name(_CPUFunctionNode, "CPUFunctionNode");
          let CPUFunctionNode = _CPUFunctionNode;
          module4.exports = {
            CPUFunctionNode
          };
        }, { "../function-node": 10 }], 7: [function(require2, module4, exports5) {
          const { utils } = require2("../../utils");
          ...
          __name(constantsToString, "constantsToString");
          function cpuKernelString(cpuKernel, name2) {
            ...
            if (cpuKernel.graphical) {
              ...
              const colorFn = utils.flattenFunctionToString((useFunctionKeyword ? "function " : "") + cpuKernel.color.toString(), {
                thisLookup: /* @__PURE__ */ __name((propertyName) => {
                  switch (propertyName) {
                    case "_colorData":
                      return "_colorData";
                    case "_imageData":
                ...
                findDependency: /* @__PURE__ */ __name((object, name3) => {
                  return null;
                }, "findDependency")
              });
              const getPixelsFn = utils.flattenFunctionToString((useFunctionKeyword ? "function " : "") + cpuKernel.getPixels.toString(), {
                ...
                findDependency: /* @__PURE__ */ __name(() => {
                  return null;
                }, "findDependency")
              });
              thisProperties.push(
...
${cpuKernel._kernelString}
  ...
  return kernel;
          ...
          __name(cpuKernelString, "cpuKernelString");
          module4.exports = {
            cpuKernelString
          };
        }, { "../../utils": 114 }], 8: [function(require2, module4, exports5) {
          ...
          const _CPUKernel = class _CPUKernel extends Kernel {
            static getFeatures() {
...
`).join("        ")}
    ...
    return {
      ...
      ${this.subKernels.map((subKernel) => `${subKernel.property}: result_${subKernel.name}`).join(",\n      ")}
          ...
          __name(_CPUKernel, "CPUKernel");
          let CPUKernel = _CPUKernel;
          module4.exports = {
            CPUKernel
          };
        }, { "../../utils": 114, "../function-builder": 9, "../kernel": 36, "./function-node": 6, "./kernel-string": 7 }], 9: [function(require2, module4, exports5) {
          const _FunctionBuilder = class _FunctionBuilder {
            static fromKernel(kernel, FunctionNode, extraNodeOptions) {
              ...
              const needsArgumentType = /* @__PURE__ */ __name((functionName, index2) => {
                return functionBuilder.needsArgumentType(functionName, index2);
              }, "needsArgumentType");
              const assignArgumentType = /* @__PURE__ */ __name((functionName, index2, type) => {
                functionBuilder.assignArgumentType(functionName, index2, type);
              }, "assignArgumentType");
              const lookupReturnType = /* @__PURE__ */ __name((functionName, ast, requestingNode) => {
                return functionBuilder.lookupReturnType(functionName, ast, requestingNode);
              }, "lookupReturnType");
              const lookupFunctionArgumentTypes = /* @__PURE__ */ __name((functionName) => {
                return functionBuilder.lookupFunctionArgumentTypes(functionName);
              }, "lookupFunctionArgumentTypes");
              const lookupFunctionArgumentName = /* @__PURE__ */ __name((functionName, argumentIndex) => {
                return functionBuilder.lookupFunctionArgumentName(functionName, argumentIndex);
              }, "lookupFunctionArgumentName");
              const lookupFunctionArgumentBitRatio = /* @__PURE__ */ __name((functionName, argumentName) => {
                return functionBuilder.lookupFunctionArgumentBitRatio(functionName, argumentName);
              }, "lookupFunctionArgumentBitRatio");
              const triggerImplyArgumentType = /* @__PURE__ */ __name((functionName, i, argumentType, requestingNode) => {
                functionBuilder.assignArgumentType(functionName, i, argumentType, requestingNode);
              }, "triggerImplyArgumentType");
              const triggerImplyArgumentBitRatio = /* @__PURE__ */ __name((functionName, argumentName, calleeFunctionName, argumentIndex) => {
                functionBuilder.assignArgumentBitRatio(functionName, argumentName, calleeFunctionName, argumentIndex);
              }, "triggerImplyArgumentBitRatio");
              const onFunctionCall = /* @__PURE__ */ __name((functionName, calleeFunctionName, args) => {
                functionBuilder.trackFunctionCall(functionName, calleeFunctionName, args);
              }, "onFunctionCall");
              const onNestedFunction = /* @__PURE__ */ __name((ast, source2) => {
              ...
              if (typeof source === "object" && source.functionNodes) {
                return new _FunctionBuilder().fromJSON(source.functionNodes, FunctionNode);
              }
              ...
              const functionBuilder = new _FunctionBuilder({
                kernel,
                rootNode,
                functionNodes,
                nativeFunctions,
          ...
          __name(_FunctionBuilder, "FunctionBuilder");
          let FunctionBuilder = _FunctionBuilder;
          module4.exports = {
            FunctionBuilder
          };
        }, {}], 10: [function(require2, module4, exports5) {
          const acorn = require2("acorn");
          const { utils } = require2("../utils");
          const { FunctionTracer } = require2("./function-tracer");
          const _FunctionNode = class _FunctionNode {
            constructor(source, settings) {
 ...
 ${debugString}`);
        ...
        }, { "../utils": 114, "./function-tracer": 11, "acorn": 1 }], 11: [function(require2, module4, exports5) {
          const { utils } = require2("../utils");
          function last(array) {
          ...
          const _FunctionTracer = class _FunctionTracer {
            constructor(ast) {
          ...
          __name(_FunctionTracer, "FunctionTracer");
          let FunctionTracer = _FunctionTracer;
          module4.exports = {
            FunctionTracer
          };
        }, { "../utils": 114 }], 12: [function(require2, module4, exports5) {
          const { glWiretap } = require2("gl-wiretap");
          const { utils } = require2("../../utils");
          function toStringWithoutUtils(fn) {
            return fn.toString().replace("=>", "").replace(/^function /, "").replace(/utils[.]/g, "/*utils.*/");
          }
          __name(toStringWithoutUtils, "toStringWithoutUtils");
          function glKernelString(Kernel, args, originKernel, setupContextString, destroyContextString) {
            ...
            const context = glWiretap(originKernel.context, {
              ...
              onReadPixels: /* @__PURE__ */ __name((targetName) => {
              ...
              onUnrecognizedArgumentLookup: /* @__PURE__ */ __name((argument) => {
...
${result.join("\n")}
          ...
          __name(glKernelString, "glKernelString");
          ...
          __name(getRenderString, "getRenderString");
          function getGetPixelsString(kernel) {
            const getPixels = kernel.getPixels.toString();
            const useFunctionKeyword = !/^function/.test(getPixels);
            return utils.flattenFunctionToString(`${useFunctionKeyword ? "function " : ""}${getPixels}`, {
              findDependency: /* @__PURE__ */ __name((object, name2) => {
                if (object === "utils") {
                  return `const ${name2} = ${utils[name2].toString()};`;
                }
                return null;
              }, "findDependency"),
              thisLookup: /* @__PURE__ */ __name((property) => {
                if (property === "context") {
                  return null;
                }
          ...
          __name(getGetPixelsString, "getGetPixelsString");
          function getToArrayString(kernelResult, textureName, framebufferName) {
            ...
            const flattenedFunctions = utils.flattenFunctionToString(`${useFunctionKeyword ? "function " : ""}${toArray}`, {
              ...
              thisLookup: /* @__PURE__ */ __name((property, isDeclaration) => {
                if (property === "texture") {
                  return textureName;
                }
                if (property === "context") {
  ...
  return toArray();
          ...
          __name(getToArrayString, "getToArrayString");
          ...
          __name(findKernelValue, "findKernelValue");
          module4.exports = {
            glKernelString
          };
        }, { "../../utils": 114, "gl-wiretap": 3 }], 13: [function(require2, module4, exports5) {
          const { Kernel } = require2("../kernel");
          const { utils } = require2("../../utils");
          ...
          const _GLKernel = class _GLKernel extends Kernel {
            static get mode() {
              return "gpu";
            }
      ...
      return 1;
            ...
            static getIsIntegerDivisionAccurate() {
              ...
              __name(kernelFunction, "kernelFunction");
...
`;
          ...
          __name(_GLKernel, "GLKernel");
          let GLKernel = _GLKernel;
          const typeMap = {
            int: "Integer",
            float: "Number",
            vec2: "Array(2)",
          ...
          __name(_GLTextureArray2Float2D, "GLTextureArray2Float2D");
          let GLTextureArray2Float2D = _GLTextureArray2Float2D;
          module4.exports = {
            GLTextureArray2Float2D
          };
        }, { "../../../utils": 114, "./float": 25 }], 15: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray2Float3D = class _GLTextureArray2Float3D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(2)";
            }
          ...
          __name(_GLTextureArray2Float3D, "GLTextureArray2Float3D");
          let GLTextureArray2Float3D = _GLTextureArray2Float3D;
          module4.exports = {
            GLTextureArray2Float3D
          };
        }, { "../../../utils": 114, "./float": 25 }], 16: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray2Float = class _GLTextureArray2Float extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(2)";
            }
          ...
          __name(_GLTextureArray2Float, "GLTextureArray2Float");
          let GLTextureArray2Float = _GLTextureArray2Float;
          module4.exports = {
            GLTextureArray2Float
          };
        }, { "../../../utils": 114, "./float": 25 }], 17: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray3Float2D = class _GLTextureArray3Float2D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
          ...
          __name(_GLTextureArray3Float2D, "GLTextureArray3Float2D");
          let GLTextureArray3Float2D = _GLTextureArray3Float2D;
          module4.exports = {
            GLTextureArray3Float2D
          };
        }, { "../../../utils": 114, "./float": 25 }], 18: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray3Float3D = class _GLTextureArray3Float3D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(3)";
            }
          ...
          __name(_GLTextureArray3Float3D, "GLTextureArray3Float3D");
          let GLTextureArray3Float3D = _GLTextureArray3Float3D;
          module4.exports = {
            GLTextureArray3Float3D
          };
        }, { "../../../utils": 114, "./float": 25 }], 19: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray3Float = class _GLTextureArray3Float extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(3)";
            }
          ...
          __name(_GLTextureArray3Float, "GLTextureArray3Float");
          let GLTextureArray3Float = _GLTextureArray3Float;
          module4.exports = {
            GLTextureArray3Float
          };
        }, { "../../../utils": 114, "./float": 25 }], 20: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray4Float2D = class _GLTextureArray4Float2D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
          ...
          __name(_GLTextureArray4Float2D, "GLTextureArray4Float2D");
          let GLTextureArray4Float2D = _GLTextureArray4Float2D;
          module4.exports = {
            GLTextureArray4Float2D
          };
        }, { "../../../utils": 114, "./float": 25 }], 21: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray4Float3D = class _GLTextureArray4Float3D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(4)";
            }
          ...
          __name(_GLTextureArray4Float3D, "GLTextureArray4Float3D");
          let GLTextureArray4Float3D = _GLTextureArray4Float3D;
          module4.exports = {
            GLTextureArray4Float3D
          };
        }, { "../../../utils": 114, "./float": 25 }], 22: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureArray4Float = class _GLTextureArray4Float extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(4)";
            }
          ...
          __name(_GLTextureArray4Float, "GLTextureArray4Float");
          let GLTextureArray4Float = _GLTextureArray4Float;
          module4.exports = {
            GLTextureArray4Float
          };
        }, { "../../../utils": 114, "./float": 25 }], 23: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureFloat2D = class _GLTextureFloat2D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
          ...
          __name(_GLTextureFloat2D, "GLTextureFloat2D");
          let GLTextureFloat2D = _GLTextureFloat2D;
          module4.exports = {
            GLTextureFloat2D
          };
        }, { "../../../utils": 114, "./float": 25 }], 24: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureFloat3D = class _GLTextureFloat3D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(1)";
            }
          ...
          __name(_GLTextureFloat3D, "GLTextureFloat3D");
          let GLTextureFloat3D = _GLTextureFloat3D;
          module4.exports = {
            GLTextureFloat3D
          };
        }, { "../../../utils": 114, "./float": 25 }], 25: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTexture } = require2("./index");
          const _GLTextureFloat = class _GLTextureFloat extends GLTexture {
            get textureType() {
          ...
          __name(_GLTextureFloat, "GLTextureFloat");
          let GLTextureFloat = _GLTextureFloat;
          module4.exports = {
            GLTextureFloat
          };
        }, { "../../../utils": 114, "./index": 27 }], 26: [function(require2, module4, exports5) {
          const { GLTextureUnsigned } = require2("./unsigned");
          const _GLTextureGraphical = class _GLTextureGraphical extends GLTextureUnsigned {
            constructor(settings) {
              super(settings);
              this.type = "ArrayTexture(4)";
            }
          ...
          __name(_GLTextureGraphical, "GLTextureGraphical");
          let GLTextureGraphical = _GLTextureGraphical;
          module4.exports = {
            GLTextureGraphical
          };
        }, { "./unsigned": 33 }], 27: [function(require2, module4, exports5) {
          const { Texture } = require2("../../../texture");
          const _GLTexture = class _GLTexture extends Texture {
            get textureType() {
          ...
          __name(selectTexture, "selectTexture");
          module4.exports = { GLTexture };
        }, { "../../../texture": 113 }], 28: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureMemoryOptimized2D = class _GLTextureMemoryOptimized2D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
          ...
          __name(_GLTextureMemoryOptimized2D, "GLTextureMemoryOptimized2D");
          let GLTextureMemoryOptimized2D = _GLTextureMemoryOptimized2D;
          module4.exports = {
            GLTextureMemoryOptimized2D
          };
        }, { "../../../utils": 114, "./float": 25 }], 29: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureMemoryOptimized3D = class _GLTextureMemoryOptimized3D extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "MemoryOptimizedNumberTexture";
            }
          ...
          __name(_GLTextureMemoryOptimized3D, "GLTextureMemoryOptimized3D");
          let GLTextureMemoryOptimized3D = _GLTextureMemoryOptimized3D;
          module4.exports = {
            GLTextureMemoryOptimized3D
          };
        }, { "../../../utils": 114, "./float": 25 }], 30: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureFloat } = require2("./float");
          const _GLTextureMemoryOptimized = class _GLTextureMemoryOptimized extends GLTextureFloat {
            constructor(settings) {
              super(settings);
              this.type = "MemoryOptimizedNumberTexture";
            }
          ...
          __name(_GLTextureMemoryOptimized, "GLTextureMemoryOptimized");
          let GLTextureMemoryOptimized = _GLTextureMemoryOptimized;
          module4.exports = {
            GLTextureMemoryOptimized
          };
        }, { "../../../utils": 114, "./float": 25 }], 31: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureUnsigned } = require2("./unsigned");
          const _GLTextureUnsigned2D = class _GLTextureUnsigned2D extends GLTextureUnsigned {
            constructor(settings) {
              super(settings);
          ...
          __name(_GLTextureUnsigned2D, "GLTextureUnsigned2D");
          let GLTextureUnsigned2D = _GLTextureUnsigned2D;
          module4.exports = {
            GLTextureUnsigned2D
          };
        }, { "../../../utils": 114, "./unsigned": 33 }], 32: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTextureUnsigned } = require2("./unsigned");
          const _GLTextureUnsigned3D = class _GLTextureUnsigned3D extends GLTextureUnsigned {
            constructor(settings) {
              super(settings);
              this.type = "NumberTexture";
            }
          ...
          __name(_GLTextureUnsigned3D, "GLTextureUnsigned3D");
          let GLTextureUnsigned3D = _GLTextureUnsigned3D;
          module4.exports = {
            GLTextureUnsigned3D
          };
        }, { "../../../utils": 114, "./unsigned": 33 }], 33: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { GLTexture } = require2("./index");
          const _GLTextureUnsigned = class _GLTextureUnsigned extends GLTexture {
            get textureType() {
          ...
          __name(_GLTextureUnsigned, "GLTextureUnsigned");
          let GLTextureUnsigned = _GLTextureUnsigned;
          module4.exports = {
            GLTextureUnsigned
          };
        }, { "../../../utils": 114, "./index": 27 }], 34: [function(require2, module4, exports5) {
          ...
          let features = null;
          const _HeadlessGLKernel = class _HeadlessGLKernel extends WebGLKernel {
            static get isSupported() {
...
`;
          ...
          __name(_HeadlessGLKernel, "HeadlessGLKernel");
          let HeadlessGLKernel = _HeadlessGLKernel;
          module4.exports = {
            HeadlessGLKernel
          };
        }, { "../gl/kernel-string": 12, "../web-gl/kernel": 70, "gl": 2 }], 35: [function(require2, module4, exports5) {
          const _KernelValue = class _KernelValue {
          ...
          __name(_KernelValue, "KernelValue");
          let KernelValue = _KernelValue;
          module4.exports = {
            KernelValue
          };
        }, {}], 36: [function(require2, module4, exports5) {
          const { utils } = require2("../utils");
          ...
          __name(splitArgumentTypes, "splitArgumentTypes");
          module4.exports = {
            Kernel
          };
        }, { "../input": 110, "../utils": 114 }], 37: [function(require2, module4, exports5) {
...
void main(void) {
  ...
  __MAIN_RESULT__;
        ...
        }, {}], 38: [function(require2, module4, exports5) {
          const { utils } = require2("../../utils");
          const { FunctionNode } = require2("../function-node");
          const _WebGLFunctionNode = class _WebGLFunctionNode extends FunctionNode {
            constructor(source, settings) {
              super(source, settings);
...
`);
          ...
          __name(_WebGLFunctionNode, "WebGLFunctionNode");
          let WebGLFunctionNode = _WebGLFunctionNode;
          const typeMap = {
            "Array": "sampler2D",
            "Array(2)": "vec2",
            "Array(3)": "vec3",
        ...
        }, { "../../utils": 114, "../function-node": 10 }], 39: [function(require2, module4, exports5) {
          ...
          __name(lookupKernelValueType, "lookupKernelValueType");
          module4.exports = {
            lookupKernelValueType,
            kernelValueMaps
          };
        }, { "./kernel-value/array2": 41, "./kernel-value/array3": 42, "./kernel-value/array4": 43, "./kernel-value/boolean": 44, "./kernel-value/dynamic-html-image": 45, "./kernel-value/dynamic-html-video": 46, "./kernel-value/dynamic-memory-optimized-number-texture": 47, "./kernel-value/dynamic-number-texture": 48, "./kernel-value/dynamic-single-array": 49, "./kernel-value/dynamic-single-array1d-i": 50, "./kernel-value/dynamic-single-array2d-i": 51, "./kernel-value/dynamic-single-array3d-i": 52, "./kernel-value/dynamic-single-input": 53, "./kernel-value/dynamic-unsigned-array": 54, "./kernel-value/dynamic-unsigned-input": 55, "./kernel-value/float": 56, "./kernel-value/html-image": 57, "./kernel-value/html-video": 58, "./kernel-value/integer": 60, "./kernel-value/memory-optimized-number-texture": 61, "./kernel-value/number-texture": 62, "./kernel-value/single-array": 63, "./kernel-value/single-array1d-i": 64, "./kernel-value/single-array2d-i": 65, "./kernel-value/single-array3d-i": 66, "./kernel-value/single-input": 67, "./kernel-value/unsigned-array": 68, "./kernel-value/unsigned-input": 69 }], 40: [function(require2, module4, exports5) {
          const { WebGLKernelValue } = require2("./index");
          const { Input } = require2("../../../input");
          const _WebGLKernelArray = class _WebGLKernelArray extends WebGLKernelValue {
          ...
          __name(_WebGLKernelArray, "WebGLKernelArray");
          let WebGLKernelArray = _WebGLKernelArray;
          module4.exports = {
            WebGLKernelArray
          };
        }, { "../../../input": 110, "./index": 59 }], 41: [function(require2, module4, exports5) {
          const { WebGLKernelValue } = require2("./index");
          const _WebGLKernelValueArray2 = class _WebGLKernelValueArray2 extends WebGLKernelValue {
            constructor(value2, settings) {
...
`;
          ...
          __name(_WebGLKernelValueArray2, "WebGLKernelValueArray2");
          let WebGLKernelValueArray2 = _WebGLKernelValueArray2;
          module4.exports = {
            WebGLKernelValueArray2
          };
        }, { "./index": 59 }], 42: [function(require2, module4, exports5) {
          const { WebGLKernelValue } = require2("./index");
          const _WebGLKernelValueArray3 = class _WebGLKernelValueArray3 extends WebGLKernelValue {
            constructor(value2, settings) {
              super(value2, settings);
              this.uploadValue = value2;
            }
...
`;
          ...
          __name(_WebGLKernelValueArray3, "WebGLKernelValueArray3");
          let WebGLKernelValueArray3 = _WebGLKernelValueArray3;
          module4.exports = {
            WebGLKernelValueArray3
          };
        }, { "./index": 59 }], 43: [function(require2, module4, exports5) {
          const { WebGLKernelValue } = require2("./index");
          const _WebGLKernelValueArray4 = class _WebGLKernelValueArray4 extends WebGLKernelValue {
            constructor(value2, settings) {
              super(value2, settings);
              this.uploadValue = value2;
            }
...
`;
          ...
          __name(_WebGLKernelValueArray4, "WebGLKernelValueArray4");
          let WebGLKernelValueArray4 = _WebGLKernelValueArray4;
          module4.exports = {
            WebGLKernelValueArray4
          };
        }, { "./index": 59 }], 44: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValue } = require2("./index");
          const _WebGLKernelValueBoolean = class _WebGLKernelValueBoolean extends WebGLKernelValue {
            constructor(value2, settings) {
              super(value2, settings);
              this.uploadValue = value2;
            }
...
`;
          ...
          __name(_WebGLKernelValueBoolean, "WebGLKernelValueBoolean");
          let WebGLKernelValueBoolean = _WebGLKernelValueBoolean;
          module4.exports = {
            WebGLKernelValueBoolean
          };
        }, { "../../../utils": 114, "./index": 59 }], 45: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueHTMLImage } = require2("./html-image");
          const _WebGLKernelValueDynamicHTMLImage = class _WebGLKernelValueDynamicHTMLImage extends WebGLKernelValueHTMLImage {
            getSource() {
          ...
          __name(_WebGLKernelValueDynamicHTMLImage, "WebGLKernelValueDynamicHTMLImage");
          let WebGLKernelValueDynamicHTMLImage = _WebGLKernelValueDynamicHTMLImage;
          module4.exports = {
            WebGLKernelValueDynamicHTMLImage
          };
        }, { "../../../utils": 114, "./html-image": 57 }], 46: [function(require2, module4, exports5) {
          const { WebGLKernelValueDynamicHTMLImage } = require2("./dynamic-html-image");
          const _WebGLKernelValueDynamicHTMLVideo = class _WebGLKernelValueDynamicHTMLVideo extends WebGLKernelValueDynamicHTMLImage {
          };
          __name(_WebGLKernelValueDynamicHTMLVideo, "WebGLKernelValueDynamicHTMLVideo");
          let WebGLKernelValueDynamicHTMLVideo = _WebGLKernelValueDynamicHTMLVideo;
          module4.exports = {
            WebGLKernelValueDynamicHTMLVideo
          };
        }, { "./dynamic-html-image": 45 }], 47: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueMemoryOptimizedNumberTexture } = require2("./memory-optimized-number-texture");
          const _WebGLKernelValueDynamicMemoryOptimizedNumberTexture = class _WebGLKernelValueDynamicMemoryOptimizedNumberTexture extends WebGLKernelValueMemoryOptimizedNumberTexture {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicMemoryOptimizedNumberTexture, "WebGLKernelValueDynamicMemoryOptimizedNumberTexture");
          let WebGLKernelValueDynamicMemoryOptimizedNumberTexture = _WebGLKernelValueDynamicMemoryOptimizedNumberTexture;
          module4.exports = {
            WebGLKernelValueDynamicMemoryOptimizedNumberTexture
          };
        }, { "../../../utils": 114, "./memory-optimized-number-texture": 61 }], 48: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueNumberTexture } = require2("./number-texture");
          const _WebGLKernelValueDynamicNumberTexture = class _WebGLKernelValueDynamicNumberTexture extends WebGLKernelValueNumberTexture {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicNumberTexture, "WebGLKernelValueDynamicNumberTexture");
          let WebGLKernelValueDynamicNumberTexture = _WebGLKernelValueDynamicNumberTexture;
          module4.exports = {
            WebGLKernelValueDynamicNumberTexture
          };
        }, { "../../../utils": 114, "./number-texture": 62 }], 49: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray } = require2("./single-array");
          const _WebGLKernelValueDynamicSingleArray = class _WebGLKernelValueDynamicSingleArray extends WebGLKernelValueSingleArray {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicSingleArray, "WebGLKernelValueDynamicSingleArray");
          let WebGLKernelValueDynamicSingleArray = _WebGLKernelValueDynamicSingleArray;
          module4.exports = {
            WebGLKernelValueDynamicSingleArray
          };
        }, { "../../../utils": 114, "./single-array": 63 }], 50: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray1DI } = require2("./single-array1d-i");
          const _WebGLKernelValueDynamicSingleArray1DI = class _WebGLKernelValueDynamicSingleArray1DI extends WebGLKernelValueSingleArray1DI {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicSingleArray1DI, "WebGLKernelValueDynamicSingleArray1DI");
          let WebGLKernelValueDynamicSingleArray1DI = _WebGLKernelValueDynamicSingleArray1DI;
          module4.exports = {
            WebGLKernelValueDynamicSingleArray1DI
          };
        }, { "../../../utils": 114, "./single-array1d-i": 64 }], 51: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray2DI } = require2("./single-array2d-i");
          const _WebGLKernelValueDynamicSingleArray2DI = class _WebGLKernelValueDynamicSingleArray2DI extends WebGLKernelValueSingleArray2DI {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicSingleArray2DI, "WebGLKernelValueDynamicSingleArray2DI");
          let WebGLKernelValueDynamicSingleArray2DI = _WebGLKernelValueDynamicSingleArray2DI;
          module4.exports = {
            WebGLKernelValueDynamicSingleArray2DI
          };
        }, { "../../../utils": 114, "./single-array2d-i": 65 }], 52: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray3DI } = require2("./single-array3d-i");
          const _WebGLKernelValueDynamicSingleArray3DI = class _WebGLKernelValueDynamicSingleArray3DI extends WebGLKernelValueSingleArray3DI {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicSingleArray3DI, "WebGLKernelValueDynamicSingleArray3DI");
          let WebGLKernelValueDynamicSingleArray3DI = _WebGLKernelValueDynamicSingleArray3DI;
          module4.exports = {
            WebGLKernelValueDynamicSingleArray3DI
          };
        }, { "../../../utils": 114, "./single-array3d-i": 66 }], 53: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleInput } = require2("./single-input");
          const _WebGLKernelValueDynamicSingleInput = class _WebGLKernelValueDynamicSingleInput extends WebGLKernelValueSingleInput {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicSingleInput, "WebGLKernelValueDynamicSingleInput");
          let WebGLKernelValueDynamicSingleInput = _WebGLKernelValueDynamicSingleInput;
          module4.exports = {
            WebGLKernelValueDynamicSingleInput
          };
        }, { "../../../utils": 114, "./single-input": 67 }], 54: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueUnsignedArray } = require2("./unsigned-array");
          const _WebGLKernelValueDynamicUnsignedArray = class _WebGLKernelValueDynamicUnsignedArray extends WebGLKernelValueUnsignedArray {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicUnsignedArray, "WebGLKernelValueDynamicUnsignedArray");
          let WebGLKernelValueDynamicUnsignedArray = _WebGLKernelValueDynamicUnsignedArray;
          module4.exports = {
            WebGLKernelValueDynamicUnsignedArray
          };
        }, { "../../../utils": 114, "./unsigned-array": 68 }], 55: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueUnsignedInput } = require2("./unsigned-input");
          const _WebGLKernelValueDynamicUnsignedInput = class _WebGLKernelValueDynamicUnsignedInput extends WebGLKernelValueUnsignedInput {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGLKernelValueDynamicUnsignedInput, "WebGLKernelValueDynamicUnsignedInput");
          let WebGLKernelValueDynamicUnsignedInput = _WebGLKernelValueDynamicUnsignedInput;
          module4.exports = {
            WebGLKernelValueDynamicUnsignedInput
          };
        }, { "../../../utils": 114, "./unsigned-input": 69 }], 56: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValue } = require2("./index");
          const _WebGLKernelValueFloat = class _WebGLKernelValueFloat extends WebGLKernelValue {
            constructor(value2, settings) {
              super(value2, settings);
              this.uploadValue = value2;
            }
...
`;
          ...
          __name(_WebGLKernelValueFloat, "WebGLKernelValueFloat");
          let WebGLKernelValueFloat = _WebGLKernelValueFloat;
          module4.exports = {
            WebGLKernelValueFloat
          };
        }, { "../../../utils": 114, "./index": 59 }], 57: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueHTMLImage = class _WebGLKernelValueHTMLImage extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              const { width, height } = value2;
              this.checkSize(width, height);
...
`;
          ...
          __name(_WebGLKernelValueHTMLImage, "WebGLKernelValueHTMLImage");
          let WebGLKernelValueHTMLImage = _WebGLKernelValueHTMLImage;
          module4.exports = {
            WebGLKernelValueHTMLImage
          };
        }, { "../../../utils": 114, "./array": 40 }], 58: [function(require2, module4, exports5) {
          const { WebGLKernelValueHTMLImage } = require2("./html-image");
          const _WebGLKernelValueHTMLVideo = class _WebGLKernelValueHTMLVideo extends WebGLKernelValueHTMLImage {
          };
          __name(_WebGLKernelValueHTMLVideo, "WebGLKernelValueHTMLVideo");
          let WebGLKernelValueHTMLVideo = _WebGLKernelValueHTMLVideo;
          module4.exports = {
            WebGLKernelValueHTMLVideo
          };
        }, { "./html-image": 57 }], 59: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { KernelValue } = require2("../../kernel-value");
          const _WebGLKernelValue = class _WebGLKernelValue extends KernelValue {
            constructor(value2, settings) {
              super(value2, settings);
          ...
          __name(_WebGLKernelValue, "WebGLKernelValue");
          let WebGLKernelValue = _WebGLKernelValue;
          module4.exports = {
            WebGLKernelValue
          };
        }, { "../../../utils": 114, "../../kernel-value": 35 }], 60: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValue } = require2("./index");
          const _WebGLKernelValueInteger = class _WebGLKernelValueInteger extends WebGLKernelValue {
            constructor(value2, settings) {
              super(value2, settings);
              this.uploadValue = value2;
            }
...
`;
          ...
          __name(_WebGLKernelValueInteger, "WebGLKernelValueInteger");
          let WebGLKernelValueInteger = _WebGLKernelValueInteger;
          module4.exports = {
            WebGLKernelValueInteger
          };
        }, { "../../../utils": 114, "./index": 59 }], 61: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          ...
          const _WebGLKernelValueMemoryOptimizedNumberTexture = class _WebGLKernelValueMemoryOptimizedNumberTexture extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
...
`;
          ...
          __name(_WebGLKernelValueMemoryOptimizedNumberTexture, "WebGLKernelValueMemoryOptimizedNumberTexture");
          let WebGLKernelValueMemoryOptimizedNumberTexture = _WebGLKernelValueMemoryOptimizedNumberTexture;
          module4.exports = {
            WebGLKernelValueMemoryOptimizedNumberTexture,
            sameError
          };
        }, { "../../../utils": 114, "./array": 40 }], 62: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const { sameError } = require2("./memory-optimized-number-texture");
          const _WebGLKernelValueNumberTexture = class _WebGLKernelValueNumberTexture extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              const [width, height] = value2.size;
              this.checkSize(width, height);
...
`;
          ...
          __name(_WebGLKernelValueNumberTexture, "WebGLKernelValueNumberTexture");
          let WebGLKernelValueNumberTexture = _WebGLKernelValueNumberTexture;
          module4.exports = {
            WebGLKernelValueNumberTexture
          };
        }, { "../../../utils": 114, "./array": 40, "./memory-optimized-number-texture": 61 }], 63: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueSingleArray = class _WebGLKernelValueSingleArray extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = 4;
              this.dimensions = utils.getDimensions(value2, true);
          ...
          __name(_WebGLKernelValueSingleArray, "WebGLKernelValueSingleArray");
          let WebGLKernelValueSingleArray = _WebGLKernelValueSingleArray;
          module4.exports = {
            WebGLKernelValueSingleArray
          };
        }, { "../../../utils": 114, "./array": 40 }], 64: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueSingleArray1DI = class _WebGLKernelValueSingleArray1DI extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = 4;
              this.setShape(value2);
          ...
          __name(_WebGLKernelValueSingleArray1DI, "WebGLKernelValueSingleArray1DI");
          let WebGLKernelValueSingleArray1DI = _WebGLKernelValueSingleArray1DI;
          module4.exports = {
            WebGLKernelValueSingleArray1DI
          };
        }, { "../../../utils": 114, "./array": 40 }], 65: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueSingleArray2DI = class _WebGLKernelValueSingleArray2DI extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = 4;
              this.setShape(value2);
          ...
          __name(_WebGLKernelValueSingleArray2DI, "WebGLKernelValueSingleArray2DI");
          let WebGLKernelValueSingleArray2DI = _WebGLKernelValueSingleArray2DI;
          module4.exports = {
            WebGLKernelValueSingleArray2DI
          };
        }, { "../../../utils": 114, "./array": 40 }], 66: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueSingleArray3DI = class _WebGLKernelValueSingleArray3DI extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = 4;
              this.setShape(value2);
          ...
          __name(_WebGLKernelValueSingleArray3DI, "WebGLKernelValueSingleArray3DI");
          let WebGLKernelValueSingleArray3DI = _WebGLKernelValueSingleArray3DI;
          module4.exports = {
            WebGLKernelValueSingleArray3DI
          };
        }, { "../../../utils": 114, "./array": 40 }], 67: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueSingleInput = class _WebGLKernelValueSingleInput extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = 4;
              let [w, h, d] = value2.size;
          ...
          __name(_WebGLKernelValueSingleInput, "WebGLKernelValueSingleInput");
          let WebGLKernelValueSingleInput = _WebGLKernelValueSingleInput;
          module4.exports = {
            WebGLKernelValueSingleInput
          };
        }, { "../../../utils": 114, "./array": 40 }], 68: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueUnsignedArray = class _WebGLKernelValueUnsignedArray extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = this.getBitRatio(value2);
              this.dimensions = utils.getDimensions(value2, true);
          ...
          __name(_WebGLKernelValueUnsignedArray, "WebGLKernelValueUnsignedArray");
          let WebGLKernelValueUnsignedArray = _WebGLKernelValueUnsignedArray;
          module4.exports = {
            WebGLKernelValueUnsignedArray
          };
        }, { "../../../utils": 114, "./array": 40 }], 69: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("./array");
          const _WebGLKernelValueUnsignedInput = class _WebGLKernelValueUnsignedInput extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
              this.bitRatio = this.getBitRatio(value2);
          ...
          __name(_WebGLKernelValueUnsignedInput, "WebGLKernelValueUnsignedInput");
          let WebGLKernelValueUnsignedInput = _WebGLKernelValueUnsignedInput;
          module4.exports = {
            WebGLKernelValueUnsignedInput
          };
        }, { "../../../utils": 114, "./array": 40 }], 70: [function(require2, module4, exports5) {
          ...
          const canvases = [];
          const maxTexSizes = {};
          const _WebGLKernel = class _WebGLKernel extends GLKernel {
            static get isSupported() {
              if (isSupported !== null) {
                return isSupported;
              }
            ...
            setupArguments(args) {
              ...
              const onRequestTexture = /* @__PURE__ */ __name(() => {
                return this.createTexture();
              }, "onRequestTexture");
              const onRequestIndex = /* @__PURE__ */ __name(() => {
                return this.constantTextureCount + textureIndexes++;
              }, "onRequestIndex");
              const onUpdateValueMismatch = /* @__PURE__ */ __name((constructor) => {
                this.switchKernels({
                  type: "argumentMismatch",
                  needed: constructor
                });
              }, "onUpdateValueMismatch");
              const onRequestContextHandle = /* @__PURE__ */ __name(() => {
            ...
            setupConstants(args) {
              ...
              for (const name2 in this.constants) {
                ...
                const kernelValue = new KernelValue(value2, {
                  ...
                  kernel: this,
                  strictIntegers: this.strictIntegers,
                  onRequestTexture: /* @__PURE__ */ __name(() => {
                    return this.createTexture();
                  }, "onRequestTexture"),
                  onRequestIndex: /* @__PURE__ */ __name(() => {
                    return textureIndexes++;
                  }, "onRequestIndex"),
                  onRequestContextHandle: /* @__PURE__ */ __name(() => {
...
float integerCorrectionModulo(float number, float divisor) {
  ...
  return number - (divisor * floor(divWithIntCheck(number, divisor)));
          ...
          __name(_WebGLKernel, "WebGLKernel");
          let WebGLKernel = _WebGLKernel;
          module4.exports = {
            WebGLKernel
          };
        }, { "../../plugins/math-random-uniformly-distributed": 112, "../../utils": 114, "../function-builder": 9, "../gl/kernel": 13, "../gl/kernel-string": 12, "./fragment-shader": 37, "./function-node": 38, "./kernel-value-maps": 39, "./vertex-shader": 71 }], 71: [function(require2, module4, exports5) {
...
void main(void) {
  ...
  vTexCoord = aTexCoord;
        ...
        }, {}], 72: [function(require2, module4, exports5) {
...
void main(void) {
  ...
  __MAIN_RESULT__;
        ...
        }, {}], 73: [function(require2, module4, exports5) {
          const { utils } = require2("../../utils");
          const { WebGLFunctionNode } = require2("../web-gl/function-node");
          const _WebGL2FunctionNode = class _WebGL2FunctionNode extends WebGLFunctionNode {
            astIdentifierExpression(idtNode, retArr) {
              if (idtNode.type !== "Identifier") {
                throw this.astErrorOutput(
                  "IdentifierExpression - not an Identifier",
          ...
          __name(_WebGL2FunctionNode, "WebGL2FunctionNode");
          let WebGL2FunctionNode = _WebGL2FunctionNode;
          module4.exports = {
            WebGL2FunctionNode
          };
        }, { "../../utils": 114, "../web-gl/function-node": 38 }], 74: [function(require2, module4, exports5) {
        ...
        }, { "./kernel-value/array2": 75, "./kernel-value/array3": 76, "./kernel-value/array4": 77, "./kernel-value/boolean": 78, "./kernel-value/dynamic-html-image": 80, "./kernel-value/dynamic-html-image-array": 79, "./kernel-value/dynamic-html-video": 81, "./kernel-value/dynamic-memory-optimized-number-texture": 82, "./kernel-value/dynamic-number-texture": 83, "./kernel-value/dynamic-single-array": 84, "./kernel-value/dynamic-single-array1d-i": 85, "./kernel-value/dynamic-single-array2d-i": 86, "./kernel-value/dynamic-single-array3d-i": 87, "./kernel-value/dynamic-single-input": 88, "./kernel-value/dynamic-unsigned-array": 89, "./kernel-value/dynamic-unsigned-input": 90, "./kernel-value/float": 91, "./kernel-value/html-image": 93, "./kernel-value/html-image-array": 92, "./kernel-value/html-video": 94, "./kernel-value/integer": 95, "./kernel-value/memory-optimized-number-texture": 96, "./kernel-value/number-texture": 97, "./kernel-value/single-array": 98, "./kernel-value/single-array1d-i": 99, "./kernel-value/single-array2d-i": 100, "./kernel-value/single-array3d-i": 101, "./kernel-value/single-input": 102, "./kernel-value/unsigned-array": 103, "./kernel-value/unsigned-input": 104 }], 75: [function(require2, module4, exports5) {
          const { WebGLKernelValueArray2 } = require2("../../web-gl/kernel-value/array2");
          const _WebGL2KernelValueArray2 = class _WebGL2KernelValueArray2 extends WebGLKernelValueArray2 {
          };
          __name(_WebGL2KernelValueArray2, "WebGL2KernelValueArray2");
          let WebGL2KernelValueArray2 = _WebGL2KernelValueArray2;
          module4.exports = {
            WebGL2KernelValueArray2
          };
        }, { "../../web-gl/kernel-value/array2": 41 }], 76: [function(require2, module4, exports5) {
          const { WebGLKernelValueArray3 } = require2("../../web-gl/kernel-value/array3");
          const _WebGL2KernelValueArray3 = class _WebGL2KernelValueArray3 extends WebGLKernelValueArray3 {
          };
          __name(_WebGL2KernelValueArray3, "WebGL2KernelValueArray3");
          let WebGL2KernelValueArray3 = _WebGL2KernelValueArray3;
          module4.exports = {
            WebGL2KernelValueArray3
          };
        }, { "../../web-gl/kernel-value/array3": 42 }], 77: [function(require2, module4, exports5) {
          const { WebGLKernelValueArray4 } = require2("../../web-gl/kernel-value/array4");
          const _WebGL2KernelValueArray4 = class _WebGL2KernelValueArray4 extends WebGLKernelValueArray4 {
          };
          __name(_WebGL2KernelValueArray4, "WebGL2KernelValueArray4");
          let WebGL2KernelValueArray4 = _WebGL2KernelValueArray4;
          module4.exports = {
            WebGL2KernelValueArray4
          };
        }, { "../../web-gl/kernel-value/array4": 43 }], 78: [function(require2, module4, exports5) {
          const { WebGLKernelValueBoolean } = require2("../../web-gl/kernel-value/boolean");
          const _WebGL2KernelValueBoolean = class _WebGL2KernelValueBoolean extends WebGLKernelValueBoolean {
          };
          __name(_WebGL2KernelValueBoolean, "WebGL2KernelValueBoolean");
          let WebGL2KernelValueBoolean = _WebGL2KernelValueBoolean;
          module4.exports = {
            WebGL2KernelValueBoolean
          };
        }, { "../../web-gl/kernel-value/boolean": 44 }], 79: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueHTMLImageArray } = require2("./html-image-array");
          const _WebGL2KernelValueDynamicHTMLImageArray = class _WebGL2KernelValueDynamicHTMLImageArray extends WebGL2KernelValueHTMLImageArray {
            getSource() {
          ...
          __name(_WebGL2KernelValueDynamicHTMLImageArray, "WebGL2KernelValueDynamicHTMLImageArray");
          let WebGL2KernelValueDynamicHTMLImageArray = _WebGL2KernelValueDynamicHTMLImageArray;
          module4.exports = {
            WebGL2KernelValueDynamicHTMLImageArray
          };
        }, { "../../../utils": 114, "./html-image-array": 92 }], 80: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueDynamicHTMLImage } = require2("../../web-gl/kernel-value/dynamic-html-image");
          const _WebGL2KernelValueDynamicHTMLImage = class _WebGL2KernelValueDynamicHTMLImage extends WebGLKernelValueDynamicHTMLImage {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
          ...
          __name(_WebGL2KernelValueDynamicHTMLImage, "WebGL2KernelValueDynamicHTMLImage");
          let WebGL2KernelValueDynamicHTMLImage = _WebGL2KernelValueDynamicHTMLImage;
          module4.exports = {
            WebGL2KernelValueDynamicHTMLImage
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-html-image": 45 }], 81: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueDynamicHTMLImage } = require2("./dynamic-html-image");
          const _WebGL2KernelValueDynamicHTMLVideo = class _WebGL2KernelValueDynamicHTMLVideo extends WebGL2KernelValueDynamicHTMLImage {
          };
          __name(_WebGL2KernelValueDynamicHTMLVideo, "WebGL2KernelValueDynamicHTMLVideo");
          let WebGL2KernelValueDynamicHTMLVideo = _WebGL2KernelValueDynamicHTMLVideo;
          module4.exports = {
            WebGL2KernelValueDynamicHTMLVideo
          };
        }, { "../../../utils": 114, "./dynamic-html-image": 80 }], 82: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          ...
          const _WebGL2KernelValueDynamicMemoryOptimizedNumberTexture = class _WebGL2KernelValueDynamicMemoryOptimizedNumberTexture extends WebGLKernelValueDynamicMemoryOptimizedNumberTexture {
            getSource() {
              return utils.linesToString([
                `uniform sampler2D ${this.id}`,
                `uniform ivec2 ${this.sizeId}`,
          ...
          __name(_WebGL2KernelValueDynamicMemoryOptimizedNumberTexture, "WebGL2KernelValueDynamicMemoryOptimizedNumberTexture");
          let WebGL2KernelValueDynamicMemoryOptimizedNumberTexture = _WebGL2KernelValueDynamicMemoryOptimizedNumberTexture;
          module4.exports = {
            WebGL2KernelValueDynamicMemoryOptimizedNumberTexture
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-memory-optimized-number-texture": 47 }], 83: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueDynamicNumberTexture } = require2("../../web-gl/kernel-value/dynamic-number-texture");
          const _WebGL2KernelValueDynamicNumberTexture = class _WebGL2KernelValueDynamicNumberTexture extends WebGLKernelValueDynamicNumberTexture {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicNumberTexture, "WebGL2KernelValueDynamicNumberTexture");
          let WebGL2KernelValueDynamicNumberTexture = _WebGL2KernelValueDynamicNumberTexture;
          module4.exports = {
            WebGL2KernelValueDynamicNumberTexture
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-number-texture": 48 }], 84: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueSingleArray } = require2("../../web-gl2/kernel-value/single-array");
          const _WebGL2KernelValueDynamicSingleArray = class _WebGL2KernelValueDynamicSingleArray extends WebGL2KernelValueSingleArray {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicSingleArray, "WebGL2KernelValueDynamicSingleArray");
          let WebGL2KernelValueDynamicSingleArray = _WebGL2KernelValueDynamicSingleArray;
          module4.exports = {
            WebGL2KernelValueDynamicSingleArray
          };
        }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array": 98 }], 85: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueSingleArray1DI } = require2("../../web-gl2/kernel-value/single-array1d-i");
          const _WebGL2KernelValueDynamicSingleArray1DI = class _WebGL2KernelValueDynamicSingleArray1DI extends WebGL2KernelValueSingleArray1DI {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicSingleArray1DI, "WebGL2KernelValueDynamicSingleArray1DI");
          let WebGL2KernelValueDynamicSingleArray1DI = _WebGL2KernelValueDynamicSingleArray1DI;
          module4.exports = {
            WebGL2KernelValueDynamicSingleArray1DI
          };
        }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array1d-i": 99 }], 86: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueSingleArray2DI } = require2("../../web-gl2/kernel-value/single-array2d-i");
          const _WebGL2KernelValueDynamicSingleArray2DI = class _WebGL2KernelValueDynamicSingleArray2DI extends WebGL2KernelValueSingleArray2DI {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicSingleArray2DI, "WebGL2KernelValueDynamicSingleArray2DI");
          let WebGL2KernelValueDynamicSingleArray2DI = _WebGL2KernelValueDynamicSingleArray2DI;
          module4.exports = {
            WebGL2KernelValueDynamicSingleArray2DI
          };
        }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array2d-i": 100 }], 87: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueSingleArray3DI } = require2("../../web-gl2/kernel-value/single-array3d-i");
          const _WebGL2KernelValueDynamicSingleArray3DI = class _WebGL2KernelValueDynamicSingleArray3DI extends WebGL2KernelValueSingleArray3DI {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicSingleArray3DI, "WebGL2KernelValueDynamicSingleArray3DI");
          let WebGL2KernelValueDynamicSingleArray3DI = _WebGL2KernelValueDynamicSingleArray3DI;
          module4.exports = {
            WebGL2KernelValueDynamicSingleArray3DI
          };
        }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-array3d-i": 101 }], 88: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueSingleInput } = require2("../../web-gl2/kernel-value/single-input");
          const _WebGL2KernelValueDynamicSingleInput = class _WebGL2KernelValueDynamicSingleInput extends WebGL2KernelValueSingleInput {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicSingleInput, "WebGL2KernelValueDynamicSingleInput");
          let WebGL2KernelValueDynamicSingleInput = _WebGL2KernelValueDynamicSingleInput;
          module4.exports = {
            WebGL2KernelValueDynamicSingleInput
          };
        }, { "../../../utils": 114, "../../web-gl2/kernel-value/single-input": 102 }], 89: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueDynamicUnsignedArray } = require2("../../web-gl/kernel-value/dynamic-unsigned-array");
          const _WebGL2KernelValueDynamicUnsignedArray = class _WebGL2KernelValueDynamicUnsignedArray extends WebGLKernelValueDynamicUnsignedArray {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicUnsignedArray, "WebGL2KernelValueDynamicUnsignedArray");
          let WebGL2KernelValueDynamicUnsignedArray = _WebGL2KernelValueDynamicUnsignedArray;
          module4.exports = {
            WebGL2KernelValueDynamicUnsignedArray
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-unsigned-array": 54 }], 90: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueDynamicUnsignedInput } = require2("../../web-gl/kernel-value/dynamic-unsigned-input");
          const _WebGL2KernelValueDynamicUnsignedInput = class _WebGL2KernelValueDynamicUnsignedInput extends WebGLKernelValueDynamicUnsignedInput {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueDynamicUnsignedInput, "WebGL2KernelValueDynamicUnsignedInput");
          let WebGL2KernelValueDynamicUnsignedInput = _WebGL2KernelValueDynamicUnsignedInput;
          module4.exports = {
            WebGL2KernelValueDynamicUnsignedInput
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/dynamic-unsigned-input": 55 }], 91: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueFloat } = require2("../../web-gl/kernel-value/float");
          const _WebGL2KernelValueFloat = class _WebGL2KernelValueFloat extends WebGLKernelValueFloat {
          };
          __name(_WebGL2KernelValueFloat, "WebGL2KernelValueFloat");
          let WebGL2KernelValueFloat = _WebGL2KernelValueFloat;
          module4.exports = {
            WebGL2KernelValueFloat
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/float": 56 }], 92: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelArray } = require2("../../web-gl/kernel-value/array");
          const _WebGL2KernelValueHTMLImageArray = class _WebGL2KernelValueHTMLImageArray extends WebGLKernelArray {
            constructor(value2, settings) {
              super(value2, settings);
...
`;
          ...
          __name(_WebGL2KernelValueHTMLImageArray, "WebGL2KernelValueHTMLImageArray");
          let WebGL2KernelValueHTMLImageArray = _WebGL2KernelValueHTMLImageArray;
          module4.exports = {
            WebGL2KernelValueHTMLImageArray
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/array": 40 }], 93: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueHTMLImage } = require2("../../web-gl/kernel-value/html-image");
          const _WebGL2KernelValueHTMLImage = class _WebGL2KernelValueHTMLImage extends WebGLKernelValueHTMLImage {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueHTMLImage, "WebGL2KernelValueHTMLImage");
          let WebGL2KernelValueHTMLImage = _WebGL2KernelValueHTMLImage;
          module4.exports = {
            WebGL2KernelValueHTMLImage
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/html-image": 57 }], 94: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGL2KernelValueHTMLImage } = require2("./html-image");
          const _WebGL2KernelValueHTMLVideo = class _WebGL2KernelValueHTMLVideo extends WebGL2KernelValueHTMLImage {
          };
          __name(_WebGL2KernelValueHTMLVideo, "WebGL2KernelValueHTMLVideo");
          let WebGL2KernelValueHTMLVideo = _WebGL2KernelValueHTMLVideo;
          module4.exports = {
            WebGL2KernelValueHTMLVideo
          };
        }, { "../../../utils": 114, "./html-image": 93 }], 95: [function(require2, module4, exports5) {
          const { WebGLKernelValueInteger } = require2("../../web-gl/kernel-value/integer");
          const _WebGL2KernelValueInteger = class _WebGL2KernelValueInteger extends WebGLKernelValueInteger {
            getSource(value2) {
              const variablePrecision = this.getVariablePrecisionString();
              if (this.origin === "constants") {
...
`;
          ...
          __name(_WebGL2KernelValueInteger, "WebGL2KernelValueInteger");
          let WebGL2KernelValueInteger = _WebGL2KernelValueInteger;
          module4.exports = {
            WebGL2KernelValueInteger
          };
        }, { "../../web-gl/kernel-value/integer": 60 }], 96: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueMemoryOptimizedNumberTexture } = require2("../../web-gl/kernel-value/memory-optimized-number-texture");
          const _WebGL2KernelValueMemoryOptimizedNumberTexture = class _WebGL2KernelValueMemoryOptimizedNumberTexture extends WebGLKernelValueMemoryOptimizedNumberTexture {
            getSource() {
          ...
          __name(_WebGL2KernelValueMemoryOptimizedNumberTexture, "WebGL2KernelValueMemoryOptimizedNumberTexture");
          let WebGL2KernelValueMemoryOptimizedNumberTexture = _WebGL2KernelValueMemoryOptimizedNumberTexture;
          module4.exports = {
            WebGL2KernelValueMemoryOptimizedNumberTexture
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/memory-optimized-number-texture": 61 }], 97: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueNumberTexture } = require2("../../web-gl/kernel-value/number-texture");
          const _WebGL2KernelValueNumberTexture = class _WebGL2KernelValueNumberTexture extends WebGLKernelValueNumberTexture {
            getSource() {
              const { id, sizeId, textureSize, dimensionsId, dimensions } = this;
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
          ...
          __name(_WebGL2KernelValueNumberTexture, "WebGL2KernelValueNumberTexture");
          let WebGL2KernelValueNumberTexture = _WebGL2KernelValueNumberTexture;
          module4.exports = {
            WebGL2KernelValueNumberTexture
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/number-texture": 62 }], 98: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray } = require2("../../web-gl/kernel-value/single-array");
          const _WebGL2KernelValueSingleArray = class _WebGL2KernelValueSingleArray extends WebGLKernelValueSingleArray {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueSingleArray, "WebGL2KernelValueSingleArray");
          let WebGL2KernelValueSingleArray = _WebGL2KernelValueSingleArray;
          module4.exports = {
            WebGL2KernelValueSingleArray
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array": 63 }], 99: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray1DI } = require2("../../web-gl/kernel-value/single-array1d-i");
          const _WebGL2KernelValueSingleArray1DI = class _WebGL2KernelValueSingleArray1DI extends WebGLKernelValueSingleArray1DI {
            updateValue(value2) {
              if (value2.constructor !== this.initialValueConstructor) {
                this.onUpdateValueMismatch(value2.constructor);
                return;
          ...
          __name(_WebGL2KernelValueSingleArray1DI, "WebGL2KernelValueSingleArray1DI");
          let WebGL2KernelValueSingleArray1DI = _WebGL2KernelValueSingleArray1DI;
          module4.exports = {
            WebGL2KernelValueSingleArray1DI
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array1d-i": 64 }], 100: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray2DI } = require2("../../web-gl/kernel-value/single-array2d-i");
          const _WebGL2KernelValueSingleArray2DI = class _WebGL2KernelValueSingleArray2DI extends WebGLKernelValueSingleArray2DI {
            updateValue(value2) {
              if (value2.constructor !== this.initialValueConstructor) {
                this.onUpdateValueMismatch(value2.constructor);
                return;
          ...
          __name(_WebGL2KernelValueSingleArray2DI, "WebGL2KernelValueSingleArray2DI");
          let WebGL2KernelValueSingleArray2DI = _WebGL2KernelValueSingleArray2DI;
          module4.exports = {
            WebGL2KernelValueSingleArray2DI
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array2d-i": 65 }], 101: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleArray3DI } = require2("../../web-gl/kernel-value/single-array3d-i");
          const _WebGL2KernelValueSingleArray3DI = class _WebGL2KernelValueSingleArray3DI extends WebGLKernelValueSingleArray3DI {
            updateValue(value2) {
              if (value2.constructor !== this.initialValueConstructor) {
                this.onUpdateValueMismatch(value2.constructor);
                return;
          ...
          __name(_WebGL2KernelValueSingleArray3DI, "WebGL2KernelValueSingleArray3DI");
          let WebGL2KernelValueSingleArray3DI = _WebGL2KernelValueSingleArray3DI;
          module4.exports = {
            WebGL2KernelValueSingleArray3DI
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/single-array3d-i": 66 }], 102: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueSingleInput } = require2("../../web-gl/kernel-value/single-input");
          const _WebGL2KernelValueSingleInput = class _WebGL2KernelValueSingleInput extends WebGLKernelValueSingleInput {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueSingleInput, "WebGL2KernelValueSingleInput");
          let WebGL2KernelValueSingleInput = _WebGL2KernelValueSingleInput;
          module4.exports = {
            WebGL2KernelValueSingleInput
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/single-input": 67 }], 103: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueUnsignedArray } = require2("../../web-gl/kernel-value/unsigned-array");
          const _WebGL2KernelValueUnsignedArray = class _WebGL2KernelValueUnsignedArray extends WebGLKernelValueUnsignedArray {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueUnsignedArray, "WebGL2KernelValueUnsignedArray");
          let WebGL2KernelValueUnsignedArray = _WebGL2KernelValueUnsignedArray;
          module4.exports = {
            WebGL2KernelValueUnsignedArray
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/unsigned-array": 68 }], 104: [function(require2, module4, exports5) {
          const { utils } = require2("../../../utils");
          const { WebGLKernelValueUnsignedInput } = require2("../../web-gl/kernel-value/unsigned-input");
          const _WebGL2KernelValueUnsignedInput = class _WebGL2KernelValueUnsignedInput extends WebGLKernelValueUnsignedInput {
            getSource() {
              const variablePrecision = this.getVariablePrecisionString();
              return utils.linesToString([
                `uniform ${variablePrecision} sampler2D ${this.id}`,
          ...
          __name(_WebGL2KernelValueUnsignedInput, "WebGL2KernelValueUnsignedInput");
          let WebGL2KernelValueUnsignedInput = _WebGL2KernelValueUnsignedInput;
          module4.exports = {
            WebGL2KernelValueUnsignedInput
          };
        }, { "../../../utils": 114, "../../web-gl/kernel-value/unsigned-input": 69 }], 105: [function(require2, module4, exports5) {
          const { WebGLKernel } = require2("../web-gl/kernel");
          ...
          let testExtensions = null;
          let features = null;
          const _WebGL2Kernel = class _WebGL2Kernel extends WebGLKernel {
            static get isSupported() {
              if (isSupported !== null) {
                return isSupported;
              }
...
`;
          ...
          __name(_WebGL2Kernel, "WebGL2Kernel");
          let WebGL2Kernel = _WebGL2Kernel;
          module4.exports = {
            WebGL2Kernel
          };
        }, { "../../utils": 114, "../function-builder": 9, "../web-gl/kernel": 70, "./fragment-shader": 72, "./function-node": 73, "./kernel-value-maps": 74, "./vertex-shader": 106 }], 106: [function(require2, module4, exports5) {
...
void main(void) {
  ...
  vTexCoord = aTexCoord;
        ...
        }, {}], 107: [function(require2, module4, exports5) {
          ...
          module4.exports = lib;
        }, { "./index": 109 }], 108: [function(require2, module4, exports5) {
          ...
          const _GPU = class _GPU {
            ...
            createKernel(source, settings) {
              ...
              __name(onRequestFallback, "onRequestFallback");
              ...
              __name(onRequestSwitchKernel, "onRequestSwitchKernel");
          ...
          __name(upgradeDeprecatedCreateKernelSettings, "upgradeDeprecatedCreateKernelSettings");
          module4.exports = {
            GPU,
            kernelOrder,
            kernelTypes
          };
        }, { "./backend/cpu/kernel": 8, "./backend/headless-gl/kernel": 34, "./backend/kernel": 36, "./backend/web-gl/kernel": 70, "./backend/web-gl2/kernel": 105, "./kernel-run-shortcut": 111, "./utils": 114, "gpu-mock.js": 4 }], 109: [function(require2, module4, exports5) {
        ...
        }, { "./utils": 114 }], 111: [function(require2, module4, exports5) {
          const { utils } = require2("./utils");
          function kernelRunShortcut(kernel) {
            let run = /* @__PURE__ */ __name(function() {
            ...
            const shortcut = /* @__PURE__ */ __name(function() {
              return run.apply(kernel, arguments);
            }, "shortcut");
          ...
          __name(kernelRunShortcut, "kernelRunShortcut");
          ...
          __name(bindKernelToShortcut, "bindKernelToShortcut");
          module4.exports = {
            kernelRunShortcut
          };
        }, { "./utils": 114 }], 112: [function(require2, module4, exports5) {
...
highp float nrand(highp vec2 n) {
  ...
  return result;
          ...
          const onBeforeRun = /* @__PURE__ */ __name((kernel) => {
        ...
        }, {}], 113: [function(require2, module4, exports5) {
        ...
        }, {}], 114: [function(require2, module4, exports5) {
          const acorn = require2("acorn");
          const { Input } = require2("./input");
          const { Texture } = require2("./texture");
          ...
          const utils = {
            ...
            flipPixels: /* @__PURE__ */ __name((pixels, width, height) => {
              const halfHeight = height / 2 | 0;
              const bytesPerRow = width * 4;
              const temp = new Uint8ClampedArray(width * 4);
              const result = pixels.slice(0);
            ...
            erectPackedFloat: /* @__PURE__ */ __name((array, width) => {
              return array.subarray(0, width);
            }, "erectPackedFloat"),
            erect2DPackedFloat: /* @__PURE__ */ __name((array, width, height) => {
            ...
            erect3DPackedFloat: /* @__PURE__ */ __name((array, width, height, depth) => {
            ...
            erectMemoryOptimizedFloat: /* @__PURE__ */ __name((array, width) => {
              return array.subarray(0, width);
            }, "erectMemoryOptimizedFloat"),
            erectMemoryOptimized2DFloat: /* @__PURE__ */ __name((array, width, height) => {
              const yResults = new Array(height);
              for (let y = 0; y < height; y++) {
            ...
            erectMemoryOptimized3DFloat: /* @__PURE__ */ __name((array, width, height, depth) => {
              const zResults = new Array(depth);
              for (let z = 0; z < depth; z++) {
                const yResults = new Array(height);
                for (let y = 0; y < height; y++) {
            ...
            erectFloat: /* @__PURE__ */ __name((array, width) => {
            ...
            erect2DFloat: /* @__PURE__ */ __name((array, width, height) => {
              const yResults = new Array(height);
              let i = 0;
              for (let y = 0; y < height; y++) {
                const xResults = new Float32Array(width);
            ...
            erect3DFloat: /* @__PURE__ */ __name((array, width, height, depth) => {
              const zResults = new Array(depth);
              let i = 0;
              for (let z = 0; z < depth; z++) {
                const yResults = new Array(height);
            ...
            erectArray2: /* @__PURE__ */ __name((array, width) => {
            ...
            erect2DArray2: /* @__PURE__ */ __name((array, width, height) => {
              const yResults = new Array(height);
              const XResultsMax = width * 4;
              for (let y = 0; y < height; y++) {
                const xResults = new Array(width);
            ...
            erect3DArray2: /* @__PURE__ */ __name((array, width, height, depth) => {
              const xResultsMax = width * 4;
              const zResults = new Array(depth);
              for (let z = 0; z < depth; z++) {
                const yResults = new Array(height);
            ...
            erectArray3: /* @__PURE__ */ __name((array, width) => {
              const xResults = new Array(width);
              const xResultsMax = width * 4;
              let i = 0;
              for (let x = 0; x < xResultsMax; x += 4) {
            ...
            erect2DArray3: /* @__PURE__ */ __name((array, width, height) => {
              const xResultsMax = width * 4;
              const yResults = new Array(height);
              for (let y = 0; y < height; y++) {
                const xResults = new Array(width);
            ...
            erect3DArray3: /* @__PURE__ */ __name((array, width, height, depth) => {
              const xResultsMax = width * 4;
              const zResults = new Array(depth);
              for (let z = 0; z < depth; z++) {
                const yResults = new Array(height);
            ...
            erectArray4: /* @__PURE__ */ __name((array, width) => {
            ...
            erect2DArray4: /* @__PURE__ */ __name((array, width, height) => {
              const xResultsMax = width * 4;
              const yResults = new Array(height);
              for (let y = 0; y < height; y++) {
                const xResults = new Array(width);
            ...
            erect3DArray4: /* @__PURE__ */ __name((array, width, height, depth) => {
              const xResultsMax = width * 4;
              const zResults = new Array(depth);
              for (let z = 0; z < depth; z++) {
                const yResults = new Array(height);
            ...
            flattenFunctionToString: /* @__PURE__ */ __name((source, settings) => {
...
${result2.join("")}}`;
            ...
            normalizeDeclarations: /* @__PURE__ */ __name((ast) => {
            ...
            splitHTMLImageToRGB: /* @__PURE__ */ __name((gpu2, image) => {
            ...
            splitRGBAToCanvases: /* @__PURE__ */ __name((gpu2, rgba, width, height) => {
            ...
            getMinifySafeName: /* @__PURE__ */ __name((fn) => {
              try {
            ...
            sanitizeName: /* @__PURE__ */ __name(function(name2) {
    ...
    })(gpuBrowser$2, gpuBrowser$2.exports);
    return gpuBrowser$2.exports;
  }
  __name(requireGpuBrowser, "requireGpuBrowser");
  var gpuBrowserExports = requireGpuBrowser();
  const gpuBrowser = /* @__PURE__ */ getDefaultExportFromCjs(gpuBrowserExports);
  ...
  function registerOperation(name2, func) {
    operations.set(name2, func);
  }
  __name(registerOperation, "registerOperation");
  function getOperation(name2) {
    const func = operations.get(name2);
    if (!func) {
      throw new Error(`Operation '${name2}' is not registered.`);
    }
    return func;
  }
  __name(getOperation, "getOperation");
  function getOperationCache(name2) {
    const operation = operations_cache.get(name2);
    if (!operation) {
      operations_cache.set(name2, new (getOperation(name2))());
      return operations_cache.get(name2);
    }
    return operation;
  }
  ...
  const _Tensor = class _Tensor {
    ...
    constructor(data, options = {}, internal_options = {}) {
      this.data = data instanceof gpuBrowserExports.Texture ? data : _flatten(data);
      this.requires_grad = options.requires_grad ?? false;
      this._shape = internal_options.shape ?? _get_shape(data instanceof gpuBrowserExports.Texture ? data.toArray() : data);
  ...
  const _Module = class _Module {
    ...
    register(name2, value2) {
      if (value2 instanceof Parameter) {
        this.register_parameter(name2, value2);
      } else {
        this.register_module(name2, value2);
      }
    }
    parameters() {
  ...
  exports2.Exp = Exp;
  exports2.Fmod = Fmod;
  exports2.GPU = gpuBrowserExports.GPU;
  exports2.Ge = Ge;
  exports2.Gt = Gt;
  exports2.Le = Le;
  exports2.Log = Log;
  ...
  exports2.nn = index$1;
  exports2.ones = ones;
  exports2.ones_like = ones_like;
  exports2.optim = index;
  exports2.pow = pow;
  exports2.rand = rand;
  ...
  exports2.zeros_like = zeros_like;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
}));
//# sourceMappingURL=torch.browser.umd.js.map
