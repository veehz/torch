    ...
    (function(f) {
      ...
      return (/* @__PURE__ */ (function() {
        ...
        (function(global2, factory) {
          typeof exports3 === "object" && typeof module3 !== "undefined" ? factory(exports3) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.acorn = {}));
          ...
          pp$8.parseStatement = function(context, topLevel, exports5) {
            ...
            switch (starttype) {
              ...
              case types$1._import:
                ...
                return starttype === types$1._import ? this.parseImport(node) : this.parseExport(node, exports5);
              default:
          ...
          pp$8.parseExportAllDeclaration = function(node, exports5) {
            if (this.options.ecmaVersion >= 11) {
              if (this.eatContextual("as")) {
                node.exported = this.parseModuleExportName();
                this.checkExport(exports5, node.exported, this.lastTokStart);
              } else {
                node.exported = null;
              }
            }
          ...
          pp$8.parseExport = function(node, exports5) {
            this.next();
            if (this.eat(types$1.star)) {
              return this.parseExportAllDeclaration(node, exports5);
            }
            ...
            if (this.shouldParseExportStatement()) {
              ...
              if (node.declaration.type === "VariableDeclaration") {
                ...
                this.checkExport(exports5, node.declaration.id, node.declaration.id.start);
              }
              node.specifiers = [];
              node.source = null;
            } else {
          ...
          pp$8.checkExport = function(exports5, name2, pos) {
            if (!exports5) {
              return;
            }
            ...
            if (hasOwn(exports5, name2)) {
              this.raiseRecoverable(pos, "Duplicate export '" + name2 + "'");
            }
            exports5[name2] = true;
          };
          pp$8.checkPatternExport = function(exports5, pat) {
            var type = pat.type;
            if (type === "Identifier") {
          ...
          pp$8.checkVariableExport = function(exports5, decls) {
            if (!exports5) {
              return;
            }
          ...
          pp$8.parseExportSpecifier = function(exports5) {
            var node = this.startNode();
          ...
          pp$8.parseExportSpecifiers = function(exports5) {
          ...
          exports4.keywordTypes = keywords;
          ...
          exports4.tokContexts = types;
          exports4.tokTypes = types$1;
...
const GPU = gpuBrowserExports.GPU;
export {
  Abs,
  Add,
  Cos,
