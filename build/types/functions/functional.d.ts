...
export declare const maximum: (a: Tensor | number, b: Tensor | number) => Tensor;
export declare const minimum: (a: Tensor | number, b: Tensor | number) => Tensor;
...
export declare const expand: (...args: (Tensor | number)[]) => Tensor;
...
export declare const sum: (...args: (Tensor | number)[]) => Tensor;
export declare const mean: (...args: (Tensor | number)[]) => Tensor;
export declare const min: (...args: (Tensor | number)[]) => Tensor;
export declare const max: (...args: (Tensor | number)[]) => Tensor;
