...
class Module {
  ...
  named_parameters(prefix = "") {
    ...
    for (const [name, module2] of Object.entries(this._modules)) {
      const fullName = prefix ? `${prefix}.${name}` : name;
      result.push(...module2.named_parameters(fullName));
    }
    return result;
  }
}
...
function export_(module2, sampleInputs) {
  const graph = [];
  const nameGen = new NameGenerator();
  const tensorIdToName = /* @__PURE__ */ new Map();
  const namedParams = module2.named_parameters();
  ...
  let output;
  try {
    output = no_grad(() => module2.forward(...sampleInputs));
  } finally {
...
exports.ExportedProgram = ExportedProgram;
exports.Max = Max;
exports.Mean = Mean;
exports.Min = Min;
exports.Sum = Sum;
exports.Tensor = Tensor;
exports.TorchFunction = TorchFunction;
...
exports.cos = cos;
exports.cross_entropy = cross_entropy;
exports.disable_no_grad = disable_no_grad;
exports.div = div;
exports.empty = empty;
exports.empty_like = empty_like;
exports.enable_no_grad = enable_no_grad;
exports.eq = eq;
...
exports.ge = ge;
exports.gt = gt;
exports.is_grad_enabled = is_grad_enabled;
exports.is_nonzero = is_nonzero;
exports.is_tensor = is_tensor;
exports.le = le;
exports.linspace = linspace;
exports.log = log;
exports.lt = lt;
exports.manual_seed = manual_seed;
...
exports.pow = pow;
exports.rand = rand;
exports.rand_like = rand_like;
exports.randint = randint;
exports.randint_like = randint_like;
exports.randn = randn;
exports.randn_like = randn_like;
...
//# sourceMappingURL=torch.node.cjs.map
